...
export const CategoryTableRow = ({ category, setCurrentCategory, setIsCreateCategoryModalOpen, deleteCategoryHandler }:
  {
        ...
        <TableCell className='md:table-cell'>
          {category.products && category.products.length > 0 ? (
            <Dialog>
              ...
              <DialogContent>
                <DialogTitle className='sr-only'>Category product list
                </DialogTitle>
                <h2>Products</h2>
