    ...
    <div className='min-h-screen'>
      ...
      <main className='container mx-auto px-4 py-12'>
        ...
        <section className='text-center'>
          <h3 className='text-3xl font-bold mb-4'>
          Ready to Transform Your Product Shopping?
          </h3>
          <p className='text-xl  mb-8'>
            Download ShopApp now and get 20% off your first in-app purchase!
          </p>
          <Button size='lg' className='bg-[#1BC464] hover:bg-[#1bc464d7]'>
      ...
      <footer className='bg-[#1BC464] text-white'>
        <Link
          href={`https://github.com/serkanaplan`}
          target='_blank'
          className='container mx-auto px-4 text-center'
        >
          <p>Copyright © {new Date().getFullYear()} ShopApp by Serkan Kaplan</p>
        </Link>
      </footer>
    </div>
  );
